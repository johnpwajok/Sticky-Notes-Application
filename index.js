...
document.getElementById("submitButton").onclick = function(){
    ...
    if (document.getElementById("note").value.length > 0) {
        ...
        editButton.onclick = function() {
            ...
            let editedText = prompt("What would you like to change the contents of this entry to?");
        ...
        document.getElementById(currentNote.id).style.backgroundColor = selectedColour;
    }
};